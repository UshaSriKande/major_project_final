...
const StepForm = ({showRadioButtons ,formData, handleChange, handleSubmit,handleRoleChange,role}) => {
  ...
  return (
    ...
    <div className={`input-container ${formData.password!='' ? 'focused' : ''}`}>
      ...
      <p style={{width:'320px',borderRadius:'30px',border:'1px solid black',padding:'15px'}}>Dont Have an Account?<Link to="/signup" onClick={handleSignupClick}>Sigh Up</Link></p>
      </div>
