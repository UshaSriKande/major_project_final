    ...
    <div style={{marginLeft:'40px'}}>
        <form className='contact-form' onSubmit={handleSubmit}>
                <h2>Contact Form</h2>
                    ...
                    <input type="email" name="email" onChange={handleChange} placeholder="Enter your email address" required/>
                    <input type="text" name="subject" onChange={handleChange} placeholder="Enter your Subject" required/>
                    <textarea rows="8" name="message" onChange={handleChange} placeholder="Message" required></textarea>
