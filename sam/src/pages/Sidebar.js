...
const Sidebar = ({ children }) => {
    ...
    const adminMenu = [
                ...
                ],},
        {
            ...
            icon: <FaDesktop />,
            subItems: [
                { name: 'ListBatches', path: '/listbatch' },
                { name: 'GuideMapping', path: '/guidemapping' },
                { name: "ProblemStatements", path: '/list', },
            ],
        },
        
        {
            ...
            subItems: [
        { name: 'ScheduleReview', path: '/review' },
        { name: 'ListReviews', path: '/listreview'},
            ],
        },
        
        { name: 'PowerBIDashboard', path: '/power', icon: <FaRegChartBar /> },
        { name: 'AssessProject', path: '/admin', icon: <FaFolderOpen /> },

    ];

    const facultyMenu = [
        { name: 'ListBatches', path: '/listbatchna', icon: <FaLayerGroup />  },
        { path: '/liststudent', name: "ProblemStatements", icon: <FaClipboardCheck />  },
        { name: 'ListReviews', path: '/listreview_na', icon: <FaThList /> },
        { name: 'PowerBIDashboard', path: '/power', icon: <FaRegChartBar /> },
        { name: 'AssessProject', path: '/faculty', icon: <FaFolderOpen /> },
    ...
    const studentMenu = [
        { path: '/liststudent', name: "ProblemStatements", icon: <FaClipboardCheck /> },
        { name: 'ListBatches', path: '/listbatchna', icon: <FaLayerGroup /> },
        { name: 'CreateProject', path: '/addnewuser', icon: <FaUserPlus /> },
        { name: 'ListReviews', path: '/listreview_na', icon: <FaThList /> },
        { name: 'PowerBIDashboard', path: '/power', icon: <FaRegChartBar /> },
